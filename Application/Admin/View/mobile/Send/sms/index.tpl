	...
	<div class="page-container">
		...
		<div style="width: 100%;float: right;">
			<div class="right_content" style="margin-left: 450px;">
				...
				<textarea name="" id="" style="	margin-top: 10px;height: 65px;width: 100%;resize:none;" class="textinput"></textarea>
				<div >
					<button class="sent">发送</button>
					<span class="record"  onclick="operation('短信记录','/service/send/sms/add')">短信记录</span>
				</div>			
			</div>
		</div>		
	</div>
