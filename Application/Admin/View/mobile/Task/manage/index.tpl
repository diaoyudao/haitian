                        ...
                        <switch name="item.status">
                            <case value="操作">
                                <if condition="session('employee')['role_type_code'] eq 'director'">
                                    ...
                                    <if condition="in_array($employee_id,$handler)">
...
<block name="footer_js">
    ...
    <script type="text/javascript">
		...
		http://dev.haitian.com/service/task/manage/index?select_type=&status_type=1
			//筛选显示
			function ScreenPopup() {
				$select_type = '{$Think.get.select_type}';
				$status_type = '{$Think.get.status_type}';
