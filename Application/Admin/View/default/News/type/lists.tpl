    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="del_more()"
                ...
                <a class="btn btn-primary radius" data-title="新增"
                   onclick="advert_add('新增','/1fd3ab97ee/news/type/add')"
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                <thead>
                <tr class="text-c">
                    <th width="25"><input type="checkbox" name="check" value="{$item.news_type_id}"></th>
                ...
                <volist name="types" id="item">
                    <tr class="text-c">
                        <td><input type="checkbox" value="{$item.news_type_id}" name="check"></td>
                        <td>{$i}</td>
                        <td>{$item.name}</td>
                        ...
                        <td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5"
                                                      onClick="advert_edit('编辑','/1fd3ab97ee/news/type/change?news_type_id={$item.news_type_id}')"
                                                      href="javascript:;" title="编辑">
                                <img style="width:14px;height:14px;" src="/public/img/iconfont/xe6df.png"/></a>
                            <a style="text-decoration:none" class="ml-5"
                               onClick="advert_del(this,'{$item.news_type_id}')"
                               href="javascript:;"
                               title="删除"><img style="width:14px;height:14px;"
                                               src="/public/img/iconfont/xe6e2.png"/></a> <a
                                    style="text-decoration:none" class="ml-5"
                                    onClick="advert_active(this,'{$item.news_type_id}')"
                                    href="javascript:;"
                                    title="删除"><img style="width:14px;height:14px;"
                                                    src="/public/img/iconfont/xe68f.png"/></a>
                        </td>
                    </tr>
                </volist>
                </tbody>
    ...
    <script type="text/javascript">
        ...
        function advert_del(obj, id) {
            layer.confirm('确认要删除吗？', function (index) {
                ...
                var param = {news_type_id: id};

                K.doAjaxDeleteById(obj, param, '/1fd3ab97ee/news/type/delete');
            });
        }
        /*生效*/
        function advert_active(obj, id) {
            layer.confirm('确认要生效吗？', function (index) {
                ...
                K.doAjaxDeleteById(obj, param, '/1fd3ab97ee/news/type/active');
            });
        }
        ...
        function del_more() {
            ...
            layer.confirm('确认要删除选中的所有记录吗？', function (index) {
                K.doAjax(param, '/1fd3ab97ee/news/type/delete', function (response) {
        ...
        function active_more() {
            ...
            layer.confirm('确认要生效选中的所有记录吗？', function (index) {
                K.doAjax(param, '/1fd3ab97ee/news/type/active', function (response) {
                    if (response.status && response.status == 'ok') {
                        window.location.replace(window.location.href);
                    } else {
                        if (response.message) {
