						...
						<volist name="item" id="item2">
							<div class="name_tel_box">
								...
								<div class="name_tel">
									...
									<span><notempty name="item2.phone"><php>$temp_phone=str_replace(',' ,'<br>' ,$item2['phone']);echo $temp_phone;</php><else/><notempty name="item2.tel"><php>$temp_tel=str_replace(',', '<br>',$item2['tel']);echo $temp_tel;</php><else/>电话未知</notempty></notempty></span>
