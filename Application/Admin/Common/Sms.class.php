...
require './Application/Admin/Common/Vendor/api_sdk/vendor/autoload.php';
...
class Sms
{
	...
	public static function getAcsClient()
	{
		...
		$accessKeyId = "LTAIY9CQpjvbUhC7"; // AccessKeyId
		
		$accessKeySecret = "w9fQknGl8PmCcT7JHgx8QD851amPue"; // AccessKeySecret
	 ...
	 * @return stdClass
	 */
	public static function sendSms($phone, $signName, $sms_code, $name)
	{
